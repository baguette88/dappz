  ...
  return (
    <s.Screen>
          ...
          >
            ...
            {Number(data.totalSupply) >= CONFIG.MAX_SUPPLY ? (
              <>
                ...
                >
                  PPTC is sold out. Please check secondary market for listings.
                </s.TextTitle>
                <s.TextDescription
                  style={{ textAlign: "center", color: "var(--accent-text)" }}
                >
        ...
        <s.Container jc={"center"} ai={"center"} style={{ width: "70%" }}>
          ...
          >
            ...
            style={{
              ...
              padding: 24,
              borderRadius: 24,
              border: "24px dashed var(--secondary)",
              boxShadow: "0px 5px 11px 2px rgba(0,0,0,0.7)",
            }}
      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          <s.Container flex={1} jc={"center"} ai={"center"}>
            <StyledImg alt={"example"} src={"/config/images/petrentals.png"} />
          </s.Container>
          <s.SpacerLarge />
          <s.Container
            flex={2}
...
Boosted PIXL/ETH LP
Many others, you’ll have to wait and see
          ...
          <s.Container flex={1} jc={"center"} ai={"center"}>
            <StyledImg
              alt={"example"}
              src={"/config/images/petrentals.png"}
              style={{ transform: "scaleX(1)" }}
            />
          </s.Container>
        </ResponsiveWrapper>
